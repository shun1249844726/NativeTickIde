...
Blockly.JavaScript.scrub_ = function(a, b) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
        var d = a.getCommentText(); (d = Blockly.utils.wrap(d, Blockly.JavaScript.COMMENT_WRAP - 3)) && (c = a.getProcedureDef ? c + ("/**\n" + Blockly.JavaScript.prefixLines(d + "\n", " * ") + " */\n") : c + Blockly.JavaScript.prefixLines(d + "\n", "// "));
...
Blockly.JavaScript.time_delay = function(a) {
    return "delay(" + (Blockly.JavaScript.valueToCode(a, "DELAY_TIME_MILI", 0) || "0") + ");\n"
};